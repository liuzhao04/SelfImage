...
import com.lz.common.utils.ReflectUtil;
...
public class PagePlugin implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        if (invocation.getTarget() instanceof RoutingStatementHandler) {
            BaseStatementHandler delegate = (BaseStatementHandler) ReflectUtil.getValueByFieldName( (RoutingStatementHandler) invocation.getTarget(),
                            "delegate");
    ...
    private String generatePageSql(String sql,Page page){  
        if(page!=null && org.apache.commons.lang3.StringUtils.isNotBlank(dialect)){  
